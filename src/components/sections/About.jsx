          ...
          <AnimatedSection delay={0.1}>
            <div className="space-y-4 text-base leading-relaxed" style={{ color: 'var(--muted)' }}>
              ...
              <p>
                ...
                and modern React or Vue.js frontends. I care deeply about CI/CD, test coverage, and
                engineering culture.
              </p>
              <p>
                Currently at <strong style={{ color: 'var(--foreground)' }}>DataTorque Ltd</strong> as Tech Lead on the
                Bhutan Integrated Tax System (BITS), a national taxation platform I architected from the
                ground up. The Payment API now handles 100k transactions per day for 200,000 Bhutanese
                taxpayers. Bhutan holds a very special place in my heart both professionally and
                personally.
              </p>
              <p>
              ...
              <p>
                Outside of work, I love travelling with my wife and two kids, playing table tennis, and
                cricket. I am a passionate traveller who has visited Bhutan four times, a
                knowledge-sharing advocate, and a firm believer that the best code is the simplest code
